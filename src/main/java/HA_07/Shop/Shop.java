...
public class Shop {
    ...
    public static final java.util.ArrayList<ShopProduct> EMPTY_products = new java.util.ArrayList<ShopProduct>() {
        @Override
        public boolean add(ShopProduct value) {
            throw new UnsupportedOperationException("No direct add! Use xy.withProducts(obj)");
        }
    };
    ...
    public static final java.util.ArrayList<ShopCustomer> EMPTY_customers = new java.util.ArrayList<ShopCustomer>() {
        @Override
        public boolean add(ShopCustomer value) {
            throw new UnsupportedOperationException("No direct add! Use xy.withCustomers(obj)");
        }
    };
    ...
    public static final java.util.ArrayList<ShopOrder> EMPTY_orders = new java.util.ArrayList<ShopOrder>() {
        @Override
        public boolean add(ShopOrder value) {
            throw new UnsupportedOperationException("No direct add! Use xy.withOrders(obj)");
        }
    };
